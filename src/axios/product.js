...
async function getAllProductApi(authToken) {
    const url = "http://192.168.10.101:9999/user/products/all"; // Đường dẫn API
...
async function createProductApi(authToken, categoryId, name, image_1, price, description, quantity) {
    const url = `http://192.168.10.101:9999/admin/products/add?categoryId=${categoryId}`; // Đường dẫn API
...
async function updateProductApi(authToken, categoryId, id, name, price, description, quantity) {
    const url = `http://192.168.10.101:9999/admin/products/update?categoryId=${categoryId}`; // Đường dẫn API
...
async function deleteProductApi(authToken, id) {
    const url = `http://192.168.10.101:9999/admin/products/delete?id=${id}`; // Đường dẫn API
