...
public class UserServiceImpl implements UserService {
	...
	public UserDTO registerUser(UserDTO userDTO) {
		...
		try {
			...
			String country = (userDTO.getAddress().getCountry()!=null)?userDTO.getAddress().getCountry():"Việt Nam";
			String city = userDTO.getAddress().getCity();
			String street = userDTO.getAddress().getStreet();
			String buildingName = userDTO.getAddress().getBuildingName();

			Address address = addressRepo.findByCountryAndCityAndStreetAndBuildingName(country,
					city, street, buildingName);

			if (address == null) {
				address = new Address(country, city, street, buildingName);
