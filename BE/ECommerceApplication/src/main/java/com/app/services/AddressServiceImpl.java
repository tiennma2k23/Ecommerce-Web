...
public class AddressServiceImpl implements AddressService {
	...
	public AddressDTO createAddress(AddressDTO addressDTO) {
		...
		Address addressFromDB = addressRepo.findByCountryAndCityAndStreetAndBuildingName(country, city, street, buildingName);
	...
	public AddressDTO updateAddress(Long addressId, Address address) {
		Address addressFromDB = addressRepo.findByCountryAndCityAndStreetAndBuildingName(
